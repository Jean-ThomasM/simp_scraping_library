...
def main():
    ...
    parser.add_argument('--sample', type=int, help="Mode échantillon : limite le nombre de fiches à scraper.")
    ...
    try:
        ...
        logging.info("Interruption volontaire par l'utilisateur. Le scraper s'arrête proprement.")
        sys.exit(0)
